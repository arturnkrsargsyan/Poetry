...
@singleton
class FetchRandomPoemUsecase implements NoParamsUsecase<PoetryEntity> {
  final IPoetryRepository _repository;

  FetchRandomPoemUsecase({required IPoetryRepository repository})
      : _repository = repository;

  @override
  Future<ApiResponse<PoetryEntity>> call() async {
    return await _repository.getRandomPoem();
  }
}
